#!/bin/bash
# configs/z_exp_gen/poe_model_val/_common.bash
...
请运行下面任一入口脚本：
  bash configs/z_exp_gen/poe_model_val/gen_tcga_brca_poe_model_val.sh
  bash configs/z_exp_gen/poe_model_val/gen_tcga_coad_poe_model_val.sh
  bash configs/z_exp_gen/poe_model_val/gen_tcga_kich_poe_model_val.sh
  bash configs/z_exp_gen/poe_model_val/gen_tcga_kirc_poe_model_val.sh
  bash configs/z_exp_gen/poe_model_val/gen_tcga_kirp_poe_model_val.sh
  bash configs/z_exp_gen/poe_model_val/gen_tcga_lihc_poe_model_val.sh
  bash configs/z_exp_gen/poe_model_val/gen_tcga_prad_poe_model_val.sh
  bash configs/z_exp_gen/poe_model_val/gen_tcga_read_poe_model_val.sh
EOF
    exit 2
fi
...
generate_poe_model_val_configs() {
    ...
    file_prefix="${FILE_PREFIX:-${STUDY#tcga_}_poe_model_val}"
