...
class MLPSingle(nn.Module):
    def __init__(
        ...
        # Input to to_logits is the flattened output of self.net:
        # [clinic_num_tokens, projection_dim//4] -> view(1, -1) -> [1, clinic_num_tokens * projection_dim//4]
        self.to_logits = nn.Sequential(
                nn.Linear(projection_dim * clinic_num_tokens // 4, n_classes)
            )
