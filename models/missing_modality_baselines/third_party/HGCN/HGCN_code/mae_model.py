...
class fusion_model_mae_2(nn.Module):
    def __init__(self,img_in_feats,rna_in_feats,cli_in_feats,n_hidden,out_classes,dropout=0.3,train_type_num=3):
        super(fusion_model_mae_2,self).__init__() 

        self.img_gnn_2 = SAGEConv(in_channels=img_in_feats,out_channels=out_classes)         
        self.img_relu_2 = GNN_relu_Block(out_classes)  
        self.rna_gnn_2 = SAGEConv(in_channels=rna_in_feats,out_channels=out_classes)          
        self.rna_relu_2 = GNN_relu_Block(out_classes)      
        self.cli_gnn_2 = SAGEConv(in_channels=cli_in_feats,out_channels=out_classes)         
